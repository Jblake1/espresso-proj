                ...
                {#each journeys as journey, index}
                    <AccordionItem open={openItem === index} class="mb-0">
                        ...
                        <svelte:fragment slot="summary">
                            <button
                                type="button"
                                class="flex items-center w-full min-w-full text-left h-10 p-0 pr-2"
                            ...
                            >
                                <div class="py-0 px-3 rounded-md flex items-center space-x-3 overflow-hidden flex-shrink min-w-0"> 
