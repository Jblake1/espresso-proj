...
<div class="flex flex-col items-start gap-4 p-4 md:flex-row md:gap-6 md:p-6">
  <div class="flex flex-col items-start gap-4">
    <div class="toDoForm">
      <form onsubmit={submit} class="border rounded-lg">
        <div class="flex justify-center w-full">
          <div class="grid grid-cols-2 gap-4">
            <div class="flex flex-col items-start gap-4 px-4">
              ...
              <select bind:value={brewingDevice} id="brewingDevice" class="select w-full px-3 py-2 border rounded min-w-30 min-h-10" disabled={!drink}>
            ...
            <div class="flex flex-col items-start gap-4 px-4">
              ...
              <select bind:value={grinder} id="grinder" class="select w-full px-3 py-2 border rounded min-w-30 min-h-10" disabled={!drink}>
              ...
              <div class="relative w-full">
                <input bind:value={coffeeBeans} bind:this={coffeeBeansEl} use:selectOnFocus 
                  type="text" id="coffeeBeans" autoComplete="off" class="input input__lg min-w-30 min-h-10"
