...
def serve_frontend(path):
    # If a specific file exists in the static folder (e.g., /assets/main.js), serve it.
    # This handles requests for CSS, JS, images, etc., generated by the Svelte build.
    if path != "" and os.path.exists(os.path.join(app.static_folder, path)):
        return send_from_directory(app.static_folder, path)
    # Otherwise, serve the index.html file for any other path.
    # This allows your Svelte router to handle frontend navigation.
    else:
        ...
        if os.path.exists(index_path):
            ...
            # Optional: Provide a fallback message if index.html is missing
